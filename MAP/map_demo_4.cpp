...
//     p1.push_back(Product1(103,"cable",5000,0));

//     vector<Product1> p2;
//     p1.push_back(Product1(1001,"iphone16",75000,10));
//     p1.push_back(Product1(1002,"charger bot",7000,5));
//     p1.push_back(Product1(1003,"cable-c",4000,0));
